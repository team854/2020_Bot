 ...
 */
public class TDriveBackwardsOnHeadingDistanceCommand extends TDriveBackwardsOnHeadingCommand {

    private static final String COMMAND_NAME =
            TDriveBackwardsOnHeadingDistanceCommand.class.getSimpleName();
     ...
     */
    public TDriveBackwardsOnHeadingDistanceCommand(double distanceInches, double heading, double speed, double timeout,
